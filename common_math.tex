...
\__wisper_key_define_surrounding:nNn #1#2#3
  {
    \__wisper_keys_define_math:n
      {
        #1 .choice:,
        #1 / parenthesis .code:n = { \cs_set_eq:NN #2 \__wisper_parenthesize:nnn },
        #1 / braces .code:n = { \cs_set_eq:NN #2 \__wisper_embrace:nnn },
        #1 / brackets .code:n = { \cs_set_eq:NN #2 \__wisper_bracketize:nnn },
        #1 / none .code:n = { \cs_set_eq:NN #2 \__wisper_surround_none:nnn },
        #1 .initial:n = #3,
      }
  }
...
\__wisper_key_define_surrounding:nNn { trace / surrounding }
  \__wisper_operator_trace_surrounding:nnn
  { braces }
\NewDocumentCommand \Trace { s o }
  {
    \__wisper_operator_trace:
    \__wisper_operator_trace_surrounding:nnn { #1 } { #2 }
  }
