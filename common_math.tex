...
\cs_new:Npn \exp_last_unbraced:NcNo #1#2#3#4
  ...
  % clist tools [[[1
% Copy & pasted \clist_map_inline:nn with slight changes to prevent unbracing
% the items.
    ...
    \clist_if_empty:NF #1
      {
        ...
        \exp_last_unbraced:NcNo \__wisper_clist_map_function_no_unbrace:Nw
...
\cs_new_protected:Npn \__wisper_clist_map_inline_no_unbrace:nn #1
  {
    \clist_set:Nn \l__clist_internal_clist {#1}
    \__wisper_clist_map_inline_no_unbrace:Nn \l__clist_internal_clist
  }
