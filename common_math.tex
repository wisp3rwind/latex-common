...
\newcommand{\tderiv}{\deriv{\dif}}
\newcommand{\pderiv}{\deriv{\del}}
\newcommand{\fderiv}{\deriv{\delta}}

% for convenience, wrap in parenthesis
% TODO: or make starred versions that parenthesize?
% TODO: doesn't work in this form, the parenthesize/bracketize hides the remaining arguments
%\newcommand{\ptderiv}{\parenthesize{\deriv{\dif}{#1}{#2}}}
%\newcommand{\ppderiv}{\parenthesize{\deriv{\del}{#1}{#2}}}
%\newcommand{\pfderiv}{\parenthesize{\deriv{\delta}{#1}{#2}}}

% for convenience, wrap in brackets
%\newcommand{\btderiv}{\bracketize{\deriv{\dif}{#1}{#2}}}
%\newcommand{\bpderiv}{\bracketize{\deriv{\del}{#1}{#2}}}
%\newcommand{\bfderiv}{\bracketize{\deriv{\delta}{#1}{#2}}}
