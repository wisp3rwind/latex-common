...
\def\VectorStylenameStd{std}
\def\VectorStylenameBold{bold}
\def\VectorStylenameArrow{arrow}
\let\stdvec\vec
\NewDocumentCommand\SetVectorStyle{m}{%
    \def\name{#1}
    \ifx\name\VectorStylenameArrow
        \renewcommand{\vec}[1]{\xvec[]{#1}}
        % Define \dvec and \ddvec for dotted and double-dotted vectors.
        \newcommand{\dvec}[1]{\xvec[.]{#1}}
        \newcommand{\ddvec}[1]{\xvec[:]{#1}}
    \else\ifx\tmp\VectorStylenameBold
        \renewcommand{\vec}[1]{\vecb{#1}}
        % Define \dvec and \ddvec for dotted and double-dotted vectors.
        \newcommand{\dvec}[1]{\dot{\vecb{#1}}}
        \newcommand{\ddvec}[1]{\ddot{\vecb{#1}}}
    \else\ifx\tmp\VectorStylenameStd
        \renewcommand{\vec}[1]{\stdvec{#1}}
        % Define \dvec and \ddvec for dotted and double-dotted vectors.
        \newcommand{\dvec}[1]{\dot{\stdvec{#1}}}
        \newcommand{\ddvec}[1]{\ddot{\stdvec{#1}}}
    \fi\fi\fi
}
\SetVectorStyle{arrow}
