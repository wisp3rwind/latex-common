...
\newcommand{\funderiv}[2]{\deriv{\delta}{#1}{#2}}
\newcommand{\funderivn}[3]{\derivn{\delta}{#1}{#2}{#3}}
\NewDocumentCommand{\funderivx}{o m >{\SplitList{;}}m}{%
    \frac{\IfNoValueTF{#1}{\delta}{\delta^{#1}} #2}
         {\ProcessList{#3}{\funderivxadd}}
}
\newcommand{\funderivxadd}[1]{\delta{#1}}
