...
% FIXME: The following leaves the \__wisper_null marker in the arguments, prevent that
\cs_new:Npn \__wisper_big_operator_with_limits_aux:Nnnnnw #1#2#3 #4#5 #6 ; #7 \q_stop
  { \__wisper_operator_with_limits:Nnnnnn #1 {#2} {#3} {#4} {#5} {#6} }
\cs_new:Npn \__wisper_big_operator_with_limits_aux:Nnnnw #1#2#3 #4 #5 ; #6 \q_stop
  { \__wisper_big_operator_with_limits_aux:Nnnnnw #1 {#2} {#3} {#4} {#5} \__wisper_null #6 \q_stop }
\cs_new:Npn \__wisper_big_operator_with_limits_aux:Nnnw #1#2#3 #4 ; #5 \q_stop
  { \__wisper_big_operator_with_limits_aux:Nnnnw #1 {#2} {#3} {#4} \__wisper_null #5 \q_stop }
\cs_new:Npn \__wisper_declare_big_operator_with_limits:NN #1#2
  {
    ...
    %\DeclareDocumentCommand #1 { s o m }
      {
        \__wisper_operator_with_limits:Nnnnnn #2 {##1} {##3} ##2
        % Starred version uses \limits
        %\tl_if_novalue:nTF {##2}
          %{ \__wisper_operator_with_limits:Nnnnnn #2 {##1} {##3} { } { } { } }
          % use \__wisper_null in order not to unbrace; braces are supposed to
          % protect commas
          %{ \__wisper_big_operator_with_limits_aux:Nnnw #2 {##1} {##3} \__wisper_null ##2 , , , \q_stop }
      }
  }
