    ...
    type / paper .code:n =
      {
        ...
        \prop_put:Nnn \g__wisper_classopts_prop {twoside} {}
        \prop_put:Nnn \g__wisper_classopts_prop {twocolumn} {}
        \str_set:Nn \g__wisper_document_type_str {paper}
        \__wisper_enable_features:n
          {
            font-TexGyre,
            math,
    ...
    \__wisper_keys_define_doc:n
      {
        ...
        features/#1/classoptions .code:n =
          {
            % FIXME: implement
            %\clist_map_inline:nn {##1}
            %\keyval_parse:NNn
            %  \prop_put:Nnn \g__wisper_classopts_prop
          },
