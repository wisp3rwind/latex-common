...
\__wisper_declare_document_type:nnn { presentation }  % [[[3
  ...
  }
  {
    ...
    % https://tex.stackexchange.com/questions/368757/add-square-brackets-to-footfullcite-in-beamer
  \renewcommand \@makefnmark
    { \,[\@thefnmark] }
  \renewcommand \@makefntext[1]
    { \usebeamerfont*{footnote} [\@thefnmark]\enspace #1 }
  }
...
\__wisper_declare_ordinary_feature:nnn { boxes }
  ...
  }
  {
    ...
    \cs_new:Npn \NewFancyBox #1#2
      {
        \exp_args:Nnx
          \DeclareInstance { fancy-box } { \tl_trim_spaces:n { #1 } } { wisper } { #2 }
        \exp_args:Nnxx
          \UseInstance { fancy-box } { \tl_trim_spaces:n { #1 } } { \tl_trim_spaces:n { #1 } }
      }
    \cs_new:Npn \NewFancyTheoremBox #1#2#3
      {
