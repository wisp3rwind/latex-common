    ...
    \__wisper_keys_define_doc:n
      {
        ...
        features/#1/options / unknown .code:n =
          { \msg_error:nn { wisper } { no-such-feature-option } },

        features/#1/conflicts / classes .tl_gset:c = {g__wisper_package_ #1 _conflicting_classes_tl},
        features/#1/conflicts / features .tl_gset:c = {g__wisper_package_ #1 _conflicting_features_tl},
        ...
        % error if enabled explicitly in some place.
        features/#1/deactivate .bool_gset:c = {g__wisper_package_ #1 _deactivated_bool},
        features/#1/deactivate_for_engines .tl_gset:c = {g__wisper_package_ #1 _deactivated_for_engines_tl},
        features/#1/deactivate_for_engines .initial:n = {},
        features/#1/deactivate_for_classes .tl_gset:c = {g__wisper_package_ #1 _deactivated_for_classes_tl},
...
\cs_new_Npn \__wisper_declare_package:nnn #1#2#3
  {
    \clist_put_right:Nn \g__wisper_all_features_packages_clist {#1}
...
\cs_new_Npn \__wisper_declare_package:nn #1#2
    ...
    \bool_if:cF {g__wisper_feature_ #1 _enabled_bool}
      {
        ...
        \clist_map_inline:vn {g__wisper_feature_ #1 _features_clist}
...
\__wisper_declare_package:nn { changepage }
  {
    disabled,
  }
...
\__wisper_declare_package:nn { showlabels }
  { options = inner }
