        ...
        \bool_if:cF {g__wisper_feature_ #1 _activated_bool}
          {
            ...
            \__wisper_store_classoptions:v {g__wisper_feature_ #1 _classopts_clist}
...
\cs_new:Npn \__wisper_store_classoptions:n #1
  {
    \keyval_parse:NNn
...
\cs_generate_variant:Nn \__wisper_store_classoptions:n { v }
...
\__wisper_declare_font:nnn { font-TexGyre }  % [[[
  ...
  }
  {
    ...
    %\__wisper_should_load_feature:n {beramono}  % used only by \mathtt
    %\__wisper_should_load_feature:n {cabin}  % used only by \mathsf
...
\__wisper_declare_feature:nnn {sron-mark-colors}
  { requires = xcolor, groups=font_only }
  {
...
\__wisper_declare_feature:nnn { biblatex-picture-sources }
  % Usage:
...
\__wisper_declare_feature:nnn { biblatex-wip-interface }
...
\__wisper_declare_feature:nnn { multiple-footnotes }
  {
    requires = bigfoot,
  }
  {
...
\__wisper_declare_feature:nnn { plots }
  { }
  {
