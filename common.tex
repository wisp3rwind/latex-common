...
\cs_new:Npn \__wisper_declare_package:n #1
  {
    ...
    \bool_new:c {g__wisper_package_ #1 _enabled_bool}

    \__wisper_keys_define_doc:n
      {
        packages/#1/enabled .bool_gset:c = {g__wisper_package_ #1 _enabled_bool},
        packages/#1/enabled .default:n = true,
        packages/#1/disabled .bool_gset_inverse:c = {g__wisper_package_ #1 _enabled_bool},
        packages/#1/enabled .default:n = true,
...
\cs_new:Npn \__wisper_configure_package:nn #1#2
  { \__wisper_keys_set_doc:nn { packages/#1 } {#2} }

\cs_new:Npn \__wisper_declare_package:nn #1#2
  {
    \__wisper_declare_package:n {#1}
    \__wisper_configure_package:nn {#1} {#2}
  }
\cs_new:Npn \__wisper_declare_package:nnn #1#2#3
  {
    \__wisper_declare_package:nn {#1} {#2}
    \cs_gset:cn {g__wisper_package_ #1 _setup_code_tl:} {#3}
  }

\cs_new:Npn \__wisper_enable_package:n #1
  { \bool_gset_true:c {g__wisper_package_ #1 _enabled_bool} }

\cs_new:Npn \__wisper_disable_package:n #1
  { \bool_gset_false:c {g__wisper_package_ #1 _enabled_bool} }
...
\__wisper_declare_package:nnn { changepage }
  {
    disabled,
    options = {
      changepage = {
...
\__wisper_declare_feature:nn { twoside }
  {
    disabled,
...
\__wisper_declare_package:nn { bigfoot }
  {
    disabled,
    options = {},
    conflicting_classes = {},
...
\__wisper_declare_feature:nnn { alphabetic-default-footnote }
  ...
  {
    \__wisper_if_package_enabled:n { bigfoot }
      {
...
\__wisper_declare_feature:nn { hyperref-bookmarks-default }
  {
    enabled,
    requires = hyperref,
    package_options = {
...
\__wisper_declare_feature:nn { hyperref-black }
  {
    enabled,
    requires = hyperref,
    package_options = {
...
\__wisper_declare_feature:nn { hyperref-pale-colors }
  {
    enabled,
    requires = hyperref,
    package_options = {
