...
\prg_new_conditional:Npnn \__strlist_if_in:nn #1#2 { p, T, F, TF }
  {
    \exp_args:No \__strlist_if_in:nww { \tl_to_str:n {#2} }
      #1 , \q_recursion_tail ,
    \__prg_break_point:
  }
\cs_new:Npn \__strlist_if_in:nww #1 #2 , #3
  {
...
\__wisper_declare_packages:n
  {
    enumitem = { enabled, options = { inline } },
    calc = enabled,
    ragged2e = enabled,
    xcolor = enabled,
    url = { enabled, options = { hyphens } },
    hyperref = enabled,
    sidenotes,
...
\__wisper_declare_packages:n
  {
    biblatex = { disabled, options = { hyperref=true } },
  }

\__wisper_declare_feature:nn { biblatex-backref }
  {
    disabled,
    requires = biblatex,
    package_options = {
...
\__wisper_declare_feature:nn { biblatex-default-verbosity }
  {
    disabled,
    requires = biblatex,
    package_options = {
...
\__wisper_declare_feature:nn { biblatex-alphabetic }
  {
    disabled,
    requires = { biblatex, biblatex-backref, biblatex-default-verbosity },
    package_options = {
      biblatex = {
...
\__wisper_declare_feature:nn { biblatex-numeric-supercite }
  {
    disabled,
    requires = { biblatex, biblatex-backref, biblatex-default-verbosity },
    package_options = {
...
\__wisper_declare_feature:nn { biblatex-alphabetic-supercite }
  {
    % FIXME: implement
  }
...
\__wisper_declare_feature:nnn { font-lmodern }
  {
    requires = lmodern,
  }
  {
...
\__wisper_declare_feature:nnn { font-fira }
  {
    requires = { FiraMono, FiraSans },
    options = {
      FiraSans = sfdefault
    },
  }
