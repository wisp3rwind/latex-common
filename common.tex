...
\__wisper_declare_feature:nnn { font-fira }  % [[[
  ...
  \__wisper_declare_feature:nnn { font-garamond }  % [[[
  {
    requires = { mathdesign },
    options = {
  ...
  \__wisper_declare_feature:nnn { font-palatino }  % [[[
  {
    requires = { mathpazo },
    options = {
      mathpazo = osf,
...
\__wisper_declare_feature:nnn { font-TexGyre }  % [[[
  {
    requires = { amsthm, newpxmath, newpxtext, fontspec },
    options = {
      newpxmath = vvarbb,
      fontspec = no-math,
    },
  }
  {
    ...
    \__wisper_load_package:n {amsthm}
