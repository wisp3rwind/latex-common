    ...
    \bool_lazy_any_p:x
      {
        \clist_map_inline:nn {#1}
          {
            % Additional pair of braces according to \bool_lazy_any_p:x syntax!
            { \str_if_eq:nVTF {##1} \c_sys_engine_str { \c_true_bool } { \c_false_bool } }
          }
      }
  }
    ...
    \bool_if:cTF {g__wisper_package_ #1 _loaded_bool}
      {
        ...
        \__wisper_if_engine:vTF {g__wisper_package_ #1 _deactivated_for_engines_tl}
          { \prg_return_true: }
          {
            \__wisper_if_classname:vTF {g__wisper_package_ #1 _deactivated_for_classes_tl}
              { \prg_return_true: }
              { \prg_return_false: }
          }
      }
    ...
    \__wisper_should_load_package:nT {#1}
      {
        ...
        \bool_gset:cn {g__wisper_package_ #1 _loaded_bool} {true}
